...
// import {signUpWithGoogle} from './components/Firebase'
      ...
      <div className=" grid h-screen w-full place-content-center ">
        {success ? (
          ...
          <div className=" flex w-full border ">
            <div className="back flex-1 w-full">JOIN US</div>
            ...
            <section className="bg-gray-900  justify-center rounded-lg">
              ...
              <form
                className="w-full form-width mx-auto p-8  rounded-lg"
              ...
              >
                ...
                <button
                  className="w-full my-5 py-2 cursor-pointer bg-teal-500 shadow-lg shadow-teal-500/50 hover:shadow-teal-500/40 text-white font-semibold rounded-lg"
                  disabled={
